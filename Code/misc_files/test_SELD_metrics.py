...
# # ------------------------- OUTPUT FORMAT FROM DESCRIPTION FILE ------------------------
# # Example of obtaining the output format from the csv description file
...
# Convert regression labels to the output format
