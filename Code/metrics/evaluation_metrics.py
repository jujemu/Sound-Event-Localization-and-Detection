...
def compute_seld_metrics_from_output_format_dict(_pred_dict, _gt_dict, _feat_cls):
    """
        Compute SELD metrics between _gt_dict and_pred_dict in output format

    :param _pred_dict: output format dict
    :param _gt_dict: output format dict
...
def regression_label_format_to_output_format(_feat_cls, _sed_labels, _doa_labels_deg):
    """
    Converts the sed (classification) and doa labels predicted in regression format to output format.
    ...
    :return: _output_dict: returns a dict containing output format
    """
...
def classification_label_format_to_output_format(_feat_cls, _labels):
    """
    Converts the seld labels predicted in classification format to output format.
...
def description_file_to_output_format(_desc_file_dict, _unique_classes, _hop_length_sec):
    """
    Reads description file in csv format. Outputs, the format results in dictionary, and additionally writes it
    to the _output_file
    ...
    :return: _output_dict: output in dicitionary format
    """
...
def load_output_format_file(_output_format_file):
    """
    Loads output format csv file and returns it in dictionary format

    :param _output_format_file: output format CSV
...
def write_output_format_file(_output_format_file, _output_format_dict):
    """
    Writes output format csv file, given output format dictionary
