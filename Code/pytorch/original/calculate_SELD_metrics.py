...
# INPUT DIRECTORY
ref_desc_files = '/home/adavanne/taitoSharedData/dataset/metadata_dev' # reference description directory location
pred_output_format_files = '/home/adavanne/taitoWorkDir/SELD/results/2_mic_dev' # predicted output format directory location
